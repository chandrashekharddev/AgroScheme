# app/models.py - WORKING VERSION (NO CHANGES NEEDED)
...
class Document(Base):
    ...
    extracted_data = Column(JSON)  # ✅ This matches your database
...
class GovernmentScheme(Base):
    ...
    scheme_type = Column(String(50), nullable=False, default="central")  # ✅ String, not Enum
